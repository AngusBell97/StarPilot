...
from openpilot.selfdrive.ui.onroad.starpilot.developer_metrics import build_developer_metric_parts, system_memory_total_gib
...
class AugmentedRoadView(CameraView):
  ...
  def _render_developer_metrics(self):
    ...
    if not lines or height > min(88, rect.height - 2 * inset):
      return
